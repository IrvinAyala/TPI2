...
public class OrdenTrabajoDetalleEstadoPasoPK implements Serializable {
    ...
    public String toString() {
        return "uesocc.edu.sv.ingnieria.TPI.definiciones.OrdenTrabajoDetalleEstadoPasoPK[ idOrdenTrabajoDetalle=" + idOrdenTrabajoDetalle + ", idProcedimientoPaso=" + idProcedimientoPaso + " ]";
    }
