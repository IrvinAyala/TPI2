 ...
 */
@Entity
@Table(name = "calendario_equipo", catalog = "tpitest", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class CalendarioEquipo implements Serializable {
    ...
    public String toString() {
        return "uesocc.edu.sv.ingnieria.TPI.definiciones.CalendarioEquipo[ idCalendarioEquipo=" + idCalendarioEquipo + " ]";
    }
