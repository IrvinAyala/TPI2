...
public class OrdenTrabajoDetalleEstadoPasoPK implements Serializable {
    ...
    public String toString() {
        return "uesocc.edu.sv.tpi2018.ejb.entities.OrdenTrabajoDetalleEstadoPasoPK[ idOrdenTrabajoDetalle=" + idOrdenTrabajoDetalle + ", idProcedimientoPaso=" + idProcedimientoPaso + " ]";
    }
